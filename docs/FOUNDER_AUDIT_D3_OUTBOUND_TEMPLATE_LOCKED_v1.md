# Founder Audit — D3 Outbound Template (Locked)
...
## Send checklist (per row)

- [ ] Meets D2 criteria (≥4/6)
- [ ] Audience named in message
- [ ] Price + scope stated
- [ ] Gateway link with UTM
- [ ] Logged in `data/channel-receipts.json` (`sent++`)
