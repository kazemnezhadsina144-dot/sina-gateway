...
create table if not exists public.gateway_leads (
  ...
  venture_route text not null check (venture_route in ('SourceA', 'Noetfield', 'TrustField', 'BuildMatch', 'Forge', 'Personal')),
  secondary_route text check (secondary_route is null or secondary_route in ('SourceA', 'Noetfield', 'TrustField', 'BuildMatch', 'Forge', 'Personal')),
  route_rule_id text,
